...
public class ReservationController {
    ...
    public ResponseEntity<Reservation> ajouterCommande(@RequestBody Reservation reservation){
    ...
    public Optional<Reservation> recupererUneCommande(@PathVariable int id){
