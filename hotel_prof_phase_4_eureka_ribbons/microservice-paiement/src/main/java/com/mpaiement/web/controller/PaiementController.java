...
public class PaiementController {
    ...
    public ResponseEntity<Paiement>  payerUneReservation(@RequestBody Paiement paiement){
        ...
        ChambreBean  chambreReq = microserviceChambresProxy.recupererUneChambre(paiement.getNumChambre());
        
        chambreReq.setStatut("Occupe");
        
        microserviceChambresProxy.updateCommande(chambreReq);
